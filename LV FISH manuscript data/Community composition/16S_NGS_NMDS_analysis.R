...
#Calculate Jaccard distances among samples based on species P/A/abundance   
  ...
  #########################################################
  #  NMDS of Amended and Unamended FLA-PS DCM and bottom  #
  #########################################################
  ...
  par(oma=c(1,1,.5,.5), mar=c(1.5,1.5,0,0))
  mds.fig.stn <- ordiplot(mds_bray, type = "none", xlim=c(-2.0,2.0), ylim=c(-2, 2), cex.axis=1)   # don't plot anything yet
  points(mds.fig.stn, "sites", pch = 21, cex = 2, col = "black", bg = "red", select = Station == 
           "18")   # plot just the samples, colour by habitat, pch=19 means plot a circle
  points(mds.fig.stn, "sites", pch = 21, cex = 2, col = "black", bg = "green", select = Station == 
           "19")
  points(mds.fig.stn, "sites", pch = 21, cex = 2, col = "black", bg = "blue", select = Station == 
           "20")
  ...
  png(file="NMDS_EN638_main_mesos_Treatment_type_Poly_Bray.png", width=1500, height=1500, res=200)
  
  setEPS()
  postscript("NMDS_EN638_main_mesos_Treatment_type_Poly_Bray.eps")
  
  par(oma=c(1,1,.5,.5), mar=c(1.5,1.5,0,0))
  mds.fig.treatment <- ordiplot(mds_bray, type = "none", xlim=c(-2.0,2.0), ylim=c(-2, 2), cex.axis=1)   # don't plot anything yet
  points(mds.fig.treatment, "sites", pch = 21, cex = 2, col = "black", bg = "gold", select = Amendment == 
           "LV")   # plot just the samples, colour by habitat, pch = 21 means plot a circle with an outline
  points(mds.fig.treatment, "sites", pch = 21, cex = 2, col = "black", bg = "steelblue1", select = Amendment == 
           "unamended")
  ...
  ordihull(mds_bray, Amendment, draw = "polygon", label = TRUE, cex=1.5) # add confidence ellipses around habitat types
  ...
  points(mds.fig.time, "sites", pch = 21, cex = 1.5, col = "black", bg = "grey70", select = IncubationTime == 
           "17")
  points(mds.fig.time, "sites", pch = 21, cex = 1.5, col = "black", bg = "grey90", select = IncubationTime == 
           "15")
  points(mds.fig.time, "sites", pch = 21, cex = 1.25, col = "black", bg = "grey80", select = IncubationTime == 
           "12")
  points(mds.fig.time, "sites", pch = 21, cex = 1.25, col = "black", bg = "grey50", select = IncubationTime == 
           "10")
  points(mds.fig.time, "sites", pch = 21, cex = 1, col = "black", bg = "grey10", select = IncubationTime == 
           "7")
  points(mds.fig.time, "sites", pch = 21, cex = 1, col = "black", bg = "grey40", select = IncubationTime == 
           "5")
  points(mds.fig.time, "sites", pch = 21, cex = 0.75, col = "black", bg = "grey60", select = IncubationTime == 
           "3")
  points(mds.fig.time, "sites", pch = 21, cex = 0.75, col = "black", bg = "grey30", select = IncubationTime == 
           "2")
  points(mds.fig.time, "sites", pch = 21, cex = 0.5, col = "black", bg = "grey90", select = IncubationTime == 
           "1")
  points(mds.fig.time, "sites", pch = 21, cex = 0.5, col = "black", bg = "black", select = IncubationTime == 
           "0")
  
  legend("topright", legend = c("0", "1", "2", "3", "5", "7", "10", "12", "15", "17"), # select cluster number 
         bg = c("black", "grey90", "grey30", "grey60", "grey40", "grey10", "grey50", "grey80", "grey90", "grey70"), col = "black", bty = "n", 
         cex = c(0.5, 0.5, 0.75, 0.75, 1, 1, 1.25, 1.25, 1.5, 1.5), pch = 21, title = "Incubation Time")
  ...
  png(file="NMDS_EN638_amended_unamended_substrate_Depth_Poly_Bray.png", width=1500, height=1500, res=200)
  
  setEPS()
  postscript("NMDS_EN638_amended_unamended_substrate_Depth_Poly_Bray.eps")
  ...
  legend("topright", legend = c("bottom", "DCM"), # select cluster number 
         col = "black", bg = c("red", "green"), bty = "n", cex = 1.5, pch = 21, title = "Depth")
  ...
  png(file="NMDS_EN638_amended_unamended_Substrate_Poly_Bray.png", width=1500, height=1500, res=200)
  
  setEPS()
  postscript("NMDS_EN638_amended_unamended_Substrate_Poly_Bray.eps")
  
  par(oma=c(1,1,.5,.5), mar=c(1.5,1.5,0,0))
  mds.fig <- ordiplot(mds_bray, type = "none", xlim=c(-2.0,2.0), ylim=c(-2, 2), cex.axis=1)   # don't plot anything yet
  points(mds.fig, "sites", pch = 19, cex = 2, col = "gold", select = Substrate == 
           "Laminarin")   # plot just the samples, colour by habitat, pch=19 means plot a circle
  points(mds.fig, "sites", pch = 19, cex = 2, col = "red", select = Substrate == 
           "Xylan")
  points(mds.fig, "sites", pch = 19, cex = 2, col = "steelblue1", select = Substrate == 
           "Chondroitin")
  points(mds.fig, "sites", pch = 19, cex = 2, col = "forestgreen", select = Substrate == 
           "Fucoidan")
  points(mds.fig, "sites", pch = 19, cex = 2, col = "blue", select = Substrate == 
           "Pullulan")
  points(mds.fig, "sites", pch = 19, cex = 2, col = "grey20", select = Substrate == 
           "Arabinogalactan")
  points(mds.fig, "sites", pch = 19, cex = 2, col = "black", select = Substrate == 
           "Control")
  points(mds.fig, "sites", pch = 19, cex = 2, col = "grey50", select = Substrate == 
           "Amended Meso")
  legend("topright", legend = c("Laminarin", "Xylan", "Chondroitin", "Fucoidan", "Pullulan", "Arabinogalactan", "Control", "Amended Meso"), # select cluster number 
         col = c("gold", "red", "steelblue1", "forestgreen", "blue", "grey20", "black", "grey50"), bty = "n", cex = 1.5, pch = 19, title = "Substrate")# add confidence ellipses around habitat types
  ...
  ano_Amendment_type = anosim(comm, y$Amendment, distance = "bray", permutations = 9999)
  ano_Amendment_type
  
  ano_IncTime = anosim(comm, y$IncubationTime, distance = "bray", permutations = 9999)
  ano_IncTime
  
  ano_Depth = anosim(comm, y$Depth_full, distance = "bray", permutations = 9999)
  ano_Depth
  
  ano_Substrate = anosim(comm, y$Substrate, distance = "bray", permutations = 9999)
  ano_Substrate
  
  #Combine main meso NMDS plots
  
  
  #########################################################
  # NMDS of Amended and Unamended FLA-PS DCM incubations  #
  #########################################################
  # Plot NMDS basic plot 
  
  png(file="NMDS_EN638_amended_unamended_substrate_Basic_vegan_Bray.png", width=1500, height=1450, res=200)
  par(oma=c(1,1,.5,.5), mar=c(1.5,1.5,0,0))
  plot(mds_bray, display = "sites",   type = "p", xlim=c(-1,1), ylim=c(-1, 1))       # plot site scores as text
  dev.off()  
  ...
  png(file="NMDS_EN638_amended_unamended_DCM_Station_Poly_Bray.png", width=1500, height=1500, res=200)
  
  setEPS()
  postscript("NMDS_EN638_amended_unamended_DCM_Station_Poly_Bray.eps")
  ...
  #Plot NMDS showing specific factors (Amendment with polygon)  
  
  png(file="NMDS_EN638_amended_unamended_DCM_Amendment_Poly_Bray.png", width=1500, height=1500, res=200)
  
  setEPS()
  postscript("NMDS_EN638_amended_unamended_DCM_Amendment_Poly_Bray.eps")
  
  par(oma=c(1,1,.5,.5), mar=c(1.5,1.5,0,0))
  mds.fig <- ordiplot(mds_bray, type = "none", xlim=c(-2.0,2.0), ylim=c(-2, 2), cex.axis=1)   # don't plot anything yet
  points(mds.fig, "sites", pch = 21, cex = 2, col = "black", bg = "gold", select = Amendment == 
           "LV")   # plot just the samples, colour by habitat, pch=19 means plot a circle
  points(mds.fig, "sites", pch = 21, cex = 2, col = "black", bg = "steelblue1", select = Amendment == 
           "unamended")
  
  legend("topright", legend = c("Amended", "Unamended"), # select cluster number 
         col = "black", bg = c("gold", "steelblue1"), bty = "n", cex = 1.5, pch = 21, title = "Amendment")# add confidence ellipses around habitat types
  ordihull(mds_bray, Amendment, draw = "polygon", label = TRUE, cex=1.5) # add confidence ellipses around habitat types
  ...
  png(file="NMDS_EN638_amended_unamended_DCM_Substrate_Poly_Bray.png", width=1500, height=1500, res=200)
  
  setEPS()
  postscript("NMDS_EN638_amended_unamended_DCM_Substrate_Poly_Bray.eps")
  ...
  points(mds.fig, "sites", pch = 21, cex = 2, col = "black", bg = "white", select = Substrate == 
           "Amended Meso")
  legend("topright", legend = c("Laminarin", "Xylan", "Chondroitin", "Fucoidan", "Pullulan", "Arabinogalactan", "Control", "Amended Meso"), # select cluster number 
         bg = c("gold", "red", "steelblue1", "forestgreen", "blue", "grey20", "black", "white"), col = "black", bty = "n", cex = 1.5, pch = 21, title = "Substrate")# add confidence ellipses around habitat types
  ordihull(mds_bray, Substrate, draw = "polygon", label = TRUE, cex=1.5) # add confidence ellipses around habitat types
  ...
  png(file="NMDS_EN638_amended_unamended_DCM_IncubationTime_Poly_Bray.png", width=1500, height=1500, res=200)
  
  setEPS()
  postscript("NMDS_EN638_amended_unamended_DCM_IncubationTime_Poly_Bray.eps")
  ...
  ano_Amendment = anosim(comm, y$Amendment, distance = "bray", permutations = 9999)
  ano_Amendment
  
  #########################################################
  # NMDS of Amended and Unamended FLA-PS Bottom incubations
  #########################################################
  # Plot NMDS basic plot 
  ...
  png(file="NMDS_EN638_amended_unamended_Bottom_Station_Poly_Bray.png", width=1500, height=1500, res=200)
  
  setEPS()
  postscript("NMDS_EN638_amended_unamended_Bottom_Station_Poly_Bray.eps")
  ...
  png(file="NMDS_EN638_amended_unamended_Bottom_Amendment_Poly_Bray.png", width=1500, height=1500, res=200)
  
  setEPS()
  postscript("NMDS_EN638_amended_unamended_Bottom_Amendment_Poly_Bray.eps")
  ...
  png(file="NMDS_EN638_amended_unamended_Bottom_Substrate_Poly_Bray.png", width=1500, height=1500, res=200)
  
  setEPS()
  postscript("NMDS_EN638_amended_unamended_Bottom_Substrate_Poly_Bray.eps")
  ...
  png(file="NMDS_EN638_amended_unamended_Bottom_IncubationTime_Poly_Bray.png", width=1500, height=1500, res=200)
  
  setEPS()
  postscript("NMDS_EN638_amended_unamended_Bottom_IncubationTime_Poly_Bray.eps")
  ...
  #########################################################
  #           NMDS of Unamended DCM incubations           #
  #########################################################
  
  # Plot NMDS basic plot 
  
  png(file="NMDS_EN638_Unamended_DCM_Basic_vegan_Bray.png", width=1500, height=1450, res=200)
  par(oma=c(1,1,.5,.5), mar=c(1.5,1.5,0,0))
  plot(mds_bray, display = "sites",   type = "p", xlim=c(-1,1), ylim=c(-1, 1))       # plot site scores as text
  dev.off()  
  ...
  png(file="NMDS_EN638_Unamended_DCM_Station_Poly_Bray.png", width=1500, height=1500, res=200)
  
  setEPS()
  postscript("NMDS_EN638_Unamended_DCM_Station_Poly_Bray.eps")
  ...
  png(file="NMDS_EN638_Unamended_DCM_Substrate_Poly_Bray.png", width=1500, height=1500, res=200)
  
  setEPS()
  postscript("NMDS_EN638_Unamended_DCM_Substrate_Poly_Bray.eps")
  ...
  png(file="NMDS_EN638_Unamended_DCM_IncubationTime_Poly_Bray.png", width=1500, height=1500, res=200)
  
  setEPS()
  postscript("NMDS_EN638_Unamended_DCM_IncubationTime_Poly_Bray.eps")
  ...
  ### ANOSIM analysis ####
  #########################################################
  #           NMDS of Amended DCM incubations             #
  #########################################################
  
  # Plot NMDS basic plot 
  
  png(file="NMDS_EN638_Amended_DCM_Basic_vegan_Bray.png", width=1500, height=1450, res=200)
  par(oma=c(1,1,.5,.5), mar=c(1.5,1.5,0,0))
  plot(mds_bray, display = "sites",   type = "p", xlim=c(-1,1), ylim=c(-1, 1))       # plot site scores as text
  dev.off()  
  ...
  png(file="NMDS_EN638_Amended_DCM_Station_Poly_Bray.png", width=1500, height=1500, res=200)
  
  setEPS()
  postscript("NMDS_EN638_Amended_DCM_Station_Poly_Bray.eps")
  ...
  png(file="NMDS_EN638_Amended_DCM_Substrate_Poly_Bray.png", width=1500, height=1500, res=200)
  
  setEPS()
  postscript("NMDS_EN638_Amended_DCM_Substrate_Poly_Bray.eps")
  ...
  png(file="NMDS_EN638_Amended_DCM_IncubationTime_Poly_Bray.png", width=1500, height=1500, res=200)
  
  setEPS()
  postscript("NMDS_EN638_Amended_DCM_IncubationTime_Poly_Bray.eps")
  ...
  #########################################################
  #        NMDS of Unamended Bottom incubations           #
  #########################################################
  ...
  #########################################################
  #        NMDS of Amended Bottom incubations             #
  #########################################################
